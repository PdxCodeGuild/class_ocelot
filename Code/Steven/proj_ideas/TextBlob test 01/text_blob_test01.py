...
# get doc contents
doc_name = 'Django_plain1.txt'
with open(doc_name, 'r', encoding='utf-8') as doc_as_string:
    doc_as_string = doc_as_string.read()  # read the contents

# make word list of book contents
blob = TextBlob(doc_as_string)
...
# print('--------------------------------------------------------')
#
# print(f'The ARI for {doc_name} is {score}')
