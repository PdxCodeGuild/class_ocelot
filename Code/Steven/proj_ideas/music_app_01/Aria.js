...
let scale_demo_bt = document.querySelector('#scale_demo_bt');
let stop_demo_bt = document.querySelector('#stop_demo_bt');
...
demo_scale_bt.onclick = function() {
    let lower_bound = parseInt(lower_bound_input.value);
    let upper_bound = parseInt(upper_bound_input.value);
    let n_notes = parseInt(n_notes_input.value);
    // melody_input.value =
    console.log(n_notes)
    for( let scale_note = lower_bound; scale_note < n_notes; scale_note++) {
        melody_input.push(scale_note)
